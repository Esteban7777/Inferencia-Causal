...
Los resultados de la estimación arrojan un efecto significativo del indice de accesibilidad a la ubicación de los proyectos VIS sobre el precio promedio del metro cuadrado. Esto se puede interpretar como un impacto de los proyectos VIS sobre la valorización del vecindario. Este impacto es positivo, mostrando que por cada punto porcentual que aumenta el indice de accesibilidad de Hansen, el precio promedio del metro cuadrado se incrementa en 1.3 puntos porcentuales.
